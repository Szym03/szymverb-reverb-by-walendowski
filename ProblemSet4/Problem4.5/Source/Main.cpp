...
{   
    ...
    for (int sample = 0; sample < inBuffer.getNumSamples(); ++sample)
    {
        for (int channel = 0; channel < inBuffer.getNumChannels(); ++channel)
        {
            ...
            if(channelReadData[sample] < 0.02 && channelReadData[sample] > -0.02){
                channelWriteData[sample] = 0;
            }else{
...
int readSoundFile (juce::AudioBuffer<float> *buffer)
{
    ...
    juce::File file("/Users/Szymon/Documents/GitHub/EP-353_ProblemSets/ProblemSet4/Problem4.5/noisy.wav");
...
int writeSoundFile (juce::AudioBuffer<float> buffer, float sampleRate)
{
    ...
    juce::File file("/Users/Szymon/Documents/GitHub/EP-353_ProblemSets/ProblemSet4/Problem4.5/noisegate.wav");
